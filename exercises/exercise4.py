...
# COMPLETAR - INICIO
numero_01, numero_02, numero_03, numero_04 = int(numero_01),int(numero_02),int(numero_03),int(numero_04)
...
# COMPLETAR - INICIO
numero_01, numero_02, numero_03 = str(numero_01),str(numero_02),str(numero_03)
...
# COMPLETAR - INICIO
numero_binario, numero_octal, numero_hexadecimal = int(numero_binario, 2) , int(numero_octal, 8), int(numero_hexadecimal, 16)
...
# COMPLETAR - INICIO
numero_01, numero_02, numero_03 = int(numero_01), int(numero_02, 16), int(numero_03, 8)
